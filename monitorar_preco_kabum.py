...
url_produto = "https://www.kabum.com.br/produto/384627/placa-de-video-rtx-3060-ventus-2x-msi-nvidia-geforce-12gb-gddr6-dlss-ray-tracing-rtx-3060-ventus-2x-12g-oc"
...
def monitorar_preco():
    while True:
        ...
        elemento_preco = soup.find('h4', {'class': 'sc-5492faee-2 ipHrwP finalPrice'})
